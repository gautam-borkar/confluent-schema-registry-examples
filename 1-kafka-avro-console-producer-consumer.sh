#!/bin/bash
# change 10.107.213.165 by your Docker ADV_HOST  
...
kafka-avro-console-producer --broker-list cp-helm-charts-cp-kafka-headless:9092 --topic test-avro --property schema.registry.url=http://cp-helm-charts-cp-schema-registry:8081 --property value.schema='{"type":"record","name":"myrecord","fields":[{"name":"f1","type":"string"}]}'
...
kafka-avro-console-producer \
    --broker-list cp-helm-charts-cp-kafka-headless:9092 --topic test-avro \
